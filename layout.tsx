...
export default async function RootLayout({
  ...
  */
  const setUpProfile = async (form: FormData) => {
    ...
    /*
      #1: Indicate that this function is a server function by adding 'use server';
    */
     "use server";

    /*
      #2: Create the new User object with a username, name, and privateKey
      HINT: 
        - 
...
const privateKey:string = newPrivateKey();

  const newUser = ({username, name, privateKey});
    ...
    /* 
      ...
      #3: Set up a try catch block to create the user's profile and log them in if successful.
      HINT: 
